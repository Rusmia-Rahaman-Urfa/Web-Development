...
$fashionProducts = []; // Initialize an empty array to store products fetched from DB
...
if ($stmt = $conn->prepare($sql)) {
    ...
    $fashionProducts = []; // Ensure it's empty to prevent display issues
}
...
<div class="product-detail-container">
    <?php if (!empty($fashionProducts)): ?>
        <?php foreach ($fashionProducts as $p): ?>
        ...
        <?php endforeach; ?>
    <?php else: ?>
        <p>No fashion dress found in this category yet. Please add some from the admin panel.</p>
    <?php endif; ?>
</div>
