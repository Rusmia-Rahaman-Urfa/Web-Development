...
$giftsProducts = []; // Initialize an empty array to store products fetched from DB
...
if ($stmt = $conn->prepare($sql)) {
    ...
    $giftsProducts = []; // Ensure it's empty to prevent display issues
}
...
<div class="product-detail-container">
    <?php if (!empty($giftsProducts)): ?>
        <?php foreach ($giftsProducts as $p): ?>
        ...
        <?php endforeach; ?>
    <?php else: ?>
        <p>No Gifts found in this category yet. Please add some from the admin panel.</p>
    <?php endif; ?>
</div>
