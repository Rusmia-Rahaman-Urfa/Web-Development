...
if ($stmt = $conn->prepare($sql)) {
    ...
    $groomingProducts = []; // Ensure it's empty to prevent display issues
}
...
<head>
    <meta charset="UTF-8">
    <title>Grooming Products - EasyShop</title>
...
<div class="product-detail-container">
    <?php if (!empty($groomingProducts)): ?>
        <?php foreach ($groomingProducts as $p): ?>
        ...
        <?php endforeach; ?>
    <?php else: ?>
        <p>No grooming product found in this category yet. Please add some from the admin panel.</p>
    <?php endif; ?>
</div>
