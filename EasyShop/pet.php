...
$petProducts = []; // Initialize an empty array to store products fetched from DB
...
if ($stmt = $conn->prepare($sql)) {
    ...
    $petProducts = []; // Ensure it's empty to prevent display issues
}
...
<div class="product-detail-container">
    <?php if (!empty($petProducts)): ?>
        <?php foreach ($petProducts as $p): ?>
        ...
        <?php endforeach; ?>
    <?php else: ?>
        <p>No Pet Food found in this category yet. Please add some from the admin panel.</p>
    <?php endif; ?>
</div>
